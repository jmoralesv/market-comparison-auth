            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ApiScope", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 12, 3, 5, 14, 6, 262, DateTimeKind.Utc).AddTicks(7246),
                            DisplayName = "Market Comparison API",
                            Emphasize = false,
                            Enabled = true,
                            Name = "Market.Comparison.Api",
                            NonEditable = false,
                            Required = false,
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientId = "client",
                            Created = new DateTime(2023, 12, 3, 5, 14, 6, 262, DateTimeKind.Utc).AddTicks(6230),
                            DPoPClockSkew = new TimeSpan(0, 0, 5, 0, 0),
                            DPoPValidationMode = 1,
                        ...
                        new
                        {
                            ...
                            ClientClaimsPrefix = "client_",
                            ClientId = "web",
                            Created = new DateTime(2023, 12, 3, 5, 14, 6, 262, DateTimeKind.Utc).AddTicks(6652),
                            DPoPClockSkew = new TimeSpan(0, 0, 5, 0, 0),
                            DPoPValidationMode = 1,
                            DeviceCodeLifetime = 300,
                            EnableLocalLogin = true,
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ClientPostLogoutRedirectUri", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 2,
                            PostLogoutRedirectUri = "https://localhost:7102/signout-callback-oidc"
                        });
                });
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ClientRedirectUri", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 2,
                            RedirectUri = "https://localhost:7102/signin-oidc"
                        });
                });
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ClientSecret", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 1,
                            Created = new DateTime(2023, 12, 3, 5, 14, 6, 262, DateTimeKind.Utc).AddTicks(6239),
                            Type = "SharedSecret",
                        ...
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            Created = new DateTime(2023, 12, 3, 5, 14, 6, 262, DateTimeKind.Utc).AddTicks(6653),
                            Type = "SharedSecret",
                            Value = "K7gNU3sdo+OL0wNhqoVWhr3g6s1xYv72ol/pe/Unols="
                        });
                });
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.IdentityResource", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 12, 3, 5, 14, 6, 262, DateTimeKind.Utc).AddTicks(6924),
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2023, 12, 3, 5, 14, 6, 262, DateTimeKind.Utc).AddTicks(6959),
                        ...
                        {
                            Id = 3,
                            Created = new DateTime(2023, 12, 3, 5, 14, 6, 262, DateTimeKind.Utc).AddTicks(7176),
                            Emphasize = false,
                            Enabled = true,
                            Name = "verification",
                            NonEditable = false,
